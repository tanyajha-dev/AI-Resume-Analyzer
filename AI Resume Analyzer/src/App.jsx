...
/HTML|CSS|JavaScript|React|Node|Tailwind|Git|GitHub|MongoDB|Express|Redux|API/gi
    ...
    if(skillMatches){
      ...
      setSkills(
        [...new Set(skillMatches)]
      );

    }

    const projectMatches =
      uploadedText.match(/project/gi);
...
function downloadPDF() {
  ...
  return (
    ...
    <div className="min-h-screen bg-black text-white flex">
      ...
      <div className="w-64 bg-zinc-900 p-6 border-r border-zinc-800 hidden md:block">
...
<div className="bg-purple-600 p-3 rounded-xl flex items-center gap-2">
<FaFileAlt/>
Dashboard
</div>
